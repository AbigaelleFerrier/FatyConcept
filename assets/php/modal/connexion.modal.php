			...
			<div class="row">
				<form class="col s12">
					...
					<div class="row">
				 	...
				 	<div class="row">
				 		<div class="input-field col s6">
				 			<input id="pwdIns" type="password" class="validate" autocomplete='current-password' required>
				 			<label for="pwdIns">Mot de passe</label>
				 		</div>
				 		<div class="input-field col s6">
				 			<input id="pwdIns2" type="password" class="validate" autocomplete='current-password' required>
				 			<label for="pwdIns2">Mot de passe</label>
				 		</div>
				 	</div>
				</form>
				<a onclick="connexion()" class="waves-effect waves-light btn right">Inscription</a>
			</div>
		</div>
